...
#include <stdfloat>
#include <cstdint>
#include "offbynull/aligner/aligners/fitting_dynamic_programming_stack_aligner.h"
...
namespace {
    using offbynull::aligner::aligners::fitting_dynamic_programming_stack_aligner::fitting_dynamic_programming_stack_aligner;
    using offbynull::aligner::scorers::simple_scorer::simple_scorer;
    using offbynull::aligner::aligners::utils::alignment_to_stacked_string;
    using offbynull::utils::is_debug_mode;

    TEST(OAAFittingDynamicProgrammingStackAlignerTest, SanityTest) {
        fitting_dynamic_programming_stack_aligner<is_debug_mode()> aligner {};
        ...
        const auto& [alignment, score] {
            aligner.align<10zu, 10zu>(down, right, substitution_scorer, gap_scorer, freeride_scorer)
        };
        EXPECT_EQ(3, score);
    ...
    TEST(OAAFittingDynamicProgrammingStackAlignerTest, ParameterizationTest) {
        fitting_dynamic_programming_stack_aligner<is_debug_mode()> aligner {};
