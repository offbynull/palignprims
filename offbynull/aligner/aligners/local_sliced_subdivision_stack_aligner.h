#ifndef OFFBYNULL_ALIGNER_ALIGNERS_LOCAL_SLICED_SUBDIVISION_STACK_ALIGNER_H
#define OFFBYNULL_ALIGNER_ALIGNERS_LOCAL_SLICED_SUBDIVISION_STACK_ALIGNER_H
...
namespace offbynull::aligner::aligners::local_sliced_subdivision_stack_aligner {
    ...
    /**
     * Local pairwise aligner using sliced subdivision algorithm (see
    ...
    class local_sliced_subdivision_stack_aligner {
    public:
...
#endif //OFFBYNULL_ALIGNER_ALIGNERS_LOCAL_SLICED_SUBDIVISION_STACK_ALIGNER_H