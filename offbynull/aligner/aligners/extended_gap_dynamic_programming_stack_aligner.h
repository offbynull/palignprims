#ifndef OFFBYNULL_ALIGNER_ALIGNERS_EXTENDED_GAP_DYNAMIC_PROGRAMMING_STACK_ALIGNER_H
#define OFFBYNULL_ALIGNER_ALIGNERS_EXTENDED_GAP_DYNAMIC_PROGRAMMING_STACK_ALIGNER_H
...
#include "offbynull/aligner/aligners/extended_gap_dynamic_programming_alignment_type_parameterizer.h"
#include "offbynull/concepts.h"
#include "offbynull/utils.h"
#include "offbynull/aligner/aligners/concepts.h"
#include "offbynull/aligner/aligners/internal_utils.h"

namespace offbynull::aligner::aligners::extended_gap_dynamic_programming_stack_aligner {
    ...
    using offbynull::aligner::aligners::extended_gap_dynamic_programming_alignment_type_parameterizer
    ::extended_gap_dynamic_programming_alignment_type_parameterizer;
    ...
    /**
     * Extended gap pairwise aligner using dynamic programming algorithm (see
     * @ref offbynull::aligner::backtrackers::pairwise_alignment_graph_backtracker::backtracker) and stack allocation.
     *
     * @tparam debug_mode `true` to enable debugging logic, `false` otherwise.
     */
    template<bool debug_mode>
    class extended_gap_dynamic_programming_stack_aligner {
    public:
...
#endif //OFFBYNULL_ALIGNER_ALIGNERS_EXTENDED_GAP_DYNAMIC_PROGRAMMING_STACK_ALIGNER_H