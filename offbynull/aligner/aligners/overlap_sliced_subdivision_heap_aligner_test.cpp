...
#include <stdfloat>
#include <cstdint>
#include "offbynull/aligner/aligners/overlap_sliced_subdivision_heap_aligner.h"
...
namespace {
    using offbynull::aligner::aligners::overlap_sliced_subdivision_heap_aligner::overlap_sliced_subdivision_heap_aligner;
    using offbynull::aligner::scorers::simple_scorer::simple_scorer;
    using offbynull::aligner::aligners::utils::alignment_to_stacked_string;
    using offbynull::utils::is_debug_mode;

    TEST(OAAOverlapSlicedSubdivisionHeapAlignerTest, SanityTest) {
        overlap_sliced_subdivision_heap_aligner<is_debug_mode()> aligner {};
    ...
    TEST(OAAOverlapSlicedSubdivisionHeapAlignerTest, ParameterizationTest) {
        overlap_sliced_subdivision_heap_aligner<is_debug_mode()> aligner {};
