#ifndef OFFBYNULL_ALIGNER_ALIGNERS_FITTING_SLICED_SUBDIVISION_HEAP_ALIGNER_H
#define OFFBYNULL_ALIGNER_ALIGNERS_FITTING_SLICED_SUBDIVISION_HEAP_ALIGNER_H
...
namespace offbynull::aligner::aligners::fitting_sliced_subdivision_heap_aligner {
    ...
    class fitting_sliced_subdivision_heap_aligner {
    public:
...
#endif //OFFBYNULL_ALIGNER_ALIGNERS_FITTING_SLICED_SUBDIVISION_HEAP_ALIGNER_H