#ifndef OFFBYNULL_ALIGNER_ALIGNERS_GLOBAL_DYNAMIC_PROGRAMMING_HEAP_ALIGNER_H
#define OFFBYNULL_ALIGNER_ALIGNERS_GLOBAL_DYNAMIC_PROGRAMMING_HEAP_ALIGNER_H
...
#include "offbynull/aligner/aligners/global_dynamic_programming_alignment_type_parameterizer.h"
#include "offbynull/concepts.h"
#include "offbynull/utils.h"
#include "offbynull/aligner/aligners/concepts.h"
#include "offbynull/aligner/aligners/internal_utils.h"

namespace offbynull::aligner::aligners::global_dynamic_programming_heap_aligner {
    ...
    using offbynull::aligner::aligners::global_dynamic_programming_alignment_type_parameterizer
    ...
    public:
         ...
         * @return Global alignment of `down` vs `right` along with the score of that alignment.
         */
        template<
        ...
        alignment_result auto align_strict(
            ...
            using CONTAINER_CREATOR_PACK = backtracker_heap_container_creator_pack<
                ...
                typename G::E,
                typename G::ED,
                typename global_dynamic_programming_alignment_type_parameterizer<N_INDEX>::PARENT_COUNT,
                typename global_dynamic_programming_alignment_type_parameterizer<N_INDEX>::SLOT_INDEX,
...
#endif //OFFBYNULL_ALIGNER_ALIGNERS_GLOBAL_DYNAMIC_PROGRAMMING_HEAP_ALIGNER_H