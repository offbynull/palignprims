#ifndef OFFBYNULL_ALIGNER_ALIGNERS_EXTENDED_GAP_DYNAMIC_PROGRAMMING_HEAP_ALIGNER_H
#define OFFBYNULL_ALIGNER_ALIGNERS_EXTENDED_GAP_DYNAMIC_PROGRAMMING_HEAP_ALIGNER_H
...
namespace offbynull::aligner::aligners::extended_gap_dynamic_programming_heap_aligner {
    ...
    class extended_gap_dynamic_programming_heap_aligner {
    public:
...
#endif //OFFBYNULL_ALIGNER_ALIGNERS_EXTENDED_GAP_DYNAMIC_PROGRAMMING_HEAP_ALIGNER_H