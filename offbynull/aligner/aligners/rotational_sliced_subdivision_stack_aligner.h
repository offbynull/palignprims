#ifndef OFFBYNULL_ALIGNER_ALIGNERS_ROTATIONAL_SLICED_SUBDIVISION_STACK_ALIGNER_H
#define OFFBYNULL_ALIGNER_ALIGNERS_ROTATIONAL_SLICED_SUBDIVISION_STACK_ALIGNER_H
...
namespace offbynull::aligner::aligners::rotational_sliced_subdivision_stack_aligner {
    ...
    class rotational_sliced_subdivision_stack_aligner {
    public:
        ...
        auto align_strict(
            ...
            const auto& [leaf_down, leaf_right] {
                find_truncation_node<N_INDEX, WEIGHT, max_right_seq_size>(
                    down,
                    right,
                    substitution_scorer,
                    gap_scorer,
...
#endif //OFFBYNULL_ALIGNER_ALIGNERS_ROTATIONAL_SLICED_SUBDIVISION_STACK_ALIGNER_H