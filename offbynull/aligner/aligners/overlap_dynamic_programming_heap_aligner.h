#ifndef OFFBYNULL_ALIGNER_ALIGNERS_OVERLAP_DYNAMIC_PROGRAMMING_HEAP_ALIGNER_H
#define OFFBYNULL_ALIGNER_ALIGNERS_OVERLAP_DYNAMIC_PROGRAMMING_HEAP_ALIGNER_H
...
namespace offbynull::aligner::aligners::overlap_dynamic_programming_heap_aligner {
    ...
    class overlap_dynamic_programming_heap_aligner {
    public:
...
#endif //OFFBYNULL_ALIGNER_ALIGNERS_OVERLAP_DYNAMIC_PROGRAMMING_HEAP_ALIGNER_H