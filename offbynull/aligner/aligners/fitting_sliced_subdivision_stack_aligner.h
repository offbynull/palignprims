#ifndef OFFBYNULL_ALIGNER_ALIGNERS_FITTING_SLICED_SUBDIVISION_STACK_ALIGNER_H
#define OFFBYNULL_ALIGNER_ALIGNERS_FITTING_SLICED_SUBDIVISION_STACK_ALIGNER_H
...
namespace offbynull::aligner::aligners::fitting_sliced_subdivision_stack_aligner {
    ...
    /**
     * Fitting pairwise aligner using sliced subdivision algorithm (see
    ...
    class fitting_sliced_subdivision_stack_aligner {
    public:
...
#endif //OFFBYNULL_ALIGNER_ALIGNERS_FITTING_SLICED_SUBDIVISION_STACK_ALIGNER_H