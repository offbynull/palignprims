#ifndef OFFBYNULL_ALIGNER_ALIGNERS_FITTING_DYNAMIC_PROGRAMMING_STACK_ALIGNER_H
#define OFFBYNULL_ALIGNER_ALIGNERS_FITTING_DYNAMIC_PROGRAMMING_STACK_ALIGNER_H
...
namespace offbynull::aligner::aligners::fitting_dynamic_programming_stack_aligner {
    ...
    class fitting_dynamic_programming_stack_aligner {
    public:
...
#endif //OFFBYNULL_ALIGNER_ALIGNERS_FITTING_DYNAMIC_PROGRAMMING_STACK_ALIGNER_H