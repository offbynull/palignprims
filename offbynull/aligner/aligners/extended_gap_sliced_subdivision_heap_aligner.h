#ifndef OFFBYNULL_ALIGNER_ALIGNERS_EXTENDED_GAP_SLICED_SUBDIVISION_HEAP_ALIGNER_H
#define OFFBYNULL_ALIGNER_ALIGNERS_EXTENDED_GAP_SLICED_SUBDIVISION_HEAP_ALIGNER_H
...
namespace offbynull::aligner::aligners::extended_gap_sliced_subdivision_heap_aligner {
    ...
    class extended_gap_sliced_subdivision_heap_aligner {
    public:
...
#endif //OFFBYNULL_ALIGNER_ALIGNERS_EXTENDED_GAP_SLICED_SUBDIVISION_HEAP_ALIGNER_H