...
#include <cstdint>
#include <stdfloat>
#include "offbynull/aligner/aligners/fitting_sliced_subdivision_stack_aligner.h"
...
namespace {
    using offbynull::aligner::aligners::fitting_sliced_subdivision_stack_aligner::fitting_sliced_subdivision_stack_aligner;
    using offbynull::aligner::scorers::simple_scorer::simple_scorer;
    using offbynull::aligner::aligners::utils::alignment_to_stacked_string;
    using offbynull::utils::is_debug_mode;

    TEST(OAAFittingSlicedSubdivisionStackAlignerTest, SanityTest) {
        fitting_sliced_subdivision_stack_aligner<is_debug_mode()> aligner {};
    ...
    TEST(OAAFittingSlicedSubdivisionStackAlignerTest, ParameterizationTest) {
        fitting_sliced_subdivision_stack_aligner<is_debug_mode()> aligner {};
