...
#include <ostream>
#include <string>
#include "offbynull/aligner/aligners/rotational_dynamic_programming_heap_aligner.h"
...
namespace {
    using offbynull::aligner::aligners::rotational_dynamic_programming_heap_aligner::rotational_dynamic_programming_heap_aligner;
    using offbynull::aligner::scorers::simple_scorer::simple_scorer;
    using offbynull::aligner::aligners::utils::alignment_to_stacked_string;
    using offbynull::utils::is_debug_mode;

    TEST(OAARotationalDynamicProgrammingHeapAlignerTest, SanityTest) {
        rotational_dynamic_programming_heap_aligner<is_debug_mode()> aligner {};
    ...
    TEST(OAARotationalDynamicProgrammingHeapAlignerTest, ParameterizationTest) {
        rotational_dynamic_programming_heap_aligner<is_debug_mode()> aligner {};
