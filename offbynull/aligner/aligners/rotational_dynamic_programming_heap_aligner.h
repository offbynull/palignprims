#ifndef OFFBYNULL_ALIGNER_ALIGNERS_ROTATIONAL_DYNAMIC_PROGRAMMING_HEAP_ALIGNER_H
#define OFFBYNULL_ALIGNER_ALIGNERS_ROTATIONAL_DYNAMIC_PROGRAMMING_HEAP_ALIGNER_H
...
namespace offbynull::aligner::aligners::rotational_dynamic_programming_heap_aligner {
    ...
    class rotational_dynamic_programming_heap_aligner {
    public:
...
#endif //OFFBYNULL_ALIGNER_ALIGNERS_ROTATIONAL_DYNAMIC_PROGRAMMING_HEAP_ALIGNER_H