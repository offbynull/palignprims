#ifndef OFFBYNULL_ALIGNER_ALIGNERS_OVERLAP_DYNAMIC_PROGRAMMING_STACK_ALIGNER_H
#define OFFBYNULL_ALIGNER_ALIGNERS_OVERLAP_DYNAMIC_PROGRAMMING_STACK_ALIGNER_H
...
#include "offbynull/aligner/aligners/overlap_dynamic_programming_alignment_type_parameterizer.h"
#include "offbynull/concepts.h"
#include "offbynull/utils.h"
#include "offbynull/aligner/aligners/concepts.h"
#include "offbynull/aligner/aligners/internal_utils.h"

namespace offbynull::aligner::aligners::overlap_dynamic_programming_stack_aligner {
    ...
    using offbynull::aligner::aligners::overlap_dynamic_programming_alignment_type_parameterizer
        ::overlap_dynamic_programming_alignment_type_parameterizer;
    ...
    public:
         ...
         * @return Overlap alignment of `down` vs `right` along with the score of that alignment.
         */
        template<
        ...
        auto align_strict(
            ...
            using CONTAINER_CREATOR_PACK = backtracker_stack_container_creator_pack<
                ...
                typename G::E,
                typename G::ED,
                typename overlap_dynamic_programming_alignment_type_parameterizer<N_INDEX>::PARENT_COUNT,
                typename overlap_dynamic_programming_alignment_type_parameterizer<N_INDEX>::SLOT_INDEX,
...
#endif //OFFBYNULL_ALIGNER_ALIGNERS_OVERLAP_DYNAMIC_PROGRAMMING_STACK_ALIGNER_H