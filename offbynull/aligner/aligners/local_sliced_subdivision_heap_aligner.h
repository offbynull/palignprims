#ifndef OFFBYNULL_ALIGNER_ALIGNERS_LOCAL_SLICED_SUBDIVISION_HEAP_ALIGNER_H
#define OFFBYNULL_ALIGNER_ALIGNERS_LOCAL_SLICED_SUBDIVISION_HEAP_ALIGNER_H
...
namespace offbynull::aligner::aligners::local_sliced_subdivision_heap_aligner {
    ...
    class local_sliced_subdivision_heap_aligner {
    public:
...
#endif //OFFBYNULL_ALIGNER_ALIGNERS_LOCAL_SLICED_SUBDIVISION_HEAP_ALIGNER_H