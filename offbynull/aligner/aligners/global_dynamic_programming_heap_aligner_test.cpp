...
namespace {
    ...
    TEST(OAAGlobalDynamicProgrammingHeapAlignerTest, SanityTest) {
        global_dynamic_programming_heap_aligner<is_debug_mode()> aligner {};
    ...
    TEST(OAAGlobalDynamicProgrammingHeapAlignerTest, ParameterizationTest) {
        global_dynamic_programming_heap_aligner<is_debug_mode()> aligner {};
        ...
        auto align_ {
            [&]<typename N_INDEX, typename WEIGHT>() {
                ...
                const auto& [alignment, score] {
                    aligner.align_strict<N_INDEX, WEIGHT>(down, right, substitution_scorer, gap_scorer)
                };
                return score;
            }
        };
