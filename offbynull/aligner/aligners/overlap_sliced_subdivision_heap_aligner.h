#ifndef OFFBYNULL_ALIGNER_ALIGNERS_OVERLAP_SLICED_SUBDIVISION_HEAP_ALIGNER_H
#define OFFBYNULL_ALIGNER_ALIGNERS_OVERLAP_SLICED_SUBDIVISION_HEAP_ALIGNER_H
...
namespace offbynull::aligner::aligners::overlap_sliced_subdivision_heap_aligner {
    ...
    class overlap_sliced_subdivision_heap_aligner {
    public:
...
#endif //OFFBYNULL_ALIGNER_ALIGNERS_OVERLAP_SLICED_SUBDIVISION_HEAP_ALIGNER_H