...
#include <stdfloat>
#include <cstdint>
#include "offbynull/aligner/aligners/overlap_dynamic_programming_stack_aligner.h"
...
namespace {
    using offbynull::aligner::aligners::overlap_dynamic_programming_stack_aligner::overlap_dynamic_programming_stack_aligner;
    using offbynull::aligner::scorers::simple_scorer::simple_scorer;
    using offbynull::aligner::aligners::utils::alignment_to_stacked_string;
    using offbynull::utils::is_debug_mode;

    TEST(OAAOverlapDynamicProgrammingStackAlignerTest, SanityTest) {
        overlap_dynamic_programming_stack_aligner<is_debug_mode()> aligner {};
    ...
    TEST(OAAOverlapDynamicProgrammingStackAlignerTest, ParameterizationTest) {
        overlap_dynamic_programming_stack_aligner<is_debug_mode()> aligner {};
