#ifndef OFFBYNULL_ALIGNER_ALIGNERS_OVERLAP_SLICED_SUBDIVISION_STACK_ALIGNER_H
#define OFFBYNULL_ALIGNER_ALIGNERS_OVERLAP_SLICED_SUBDIVISION_STACK_ALIGNER_H
...
namespace offbynull::aligner::aligners::overlap_sliced_subdivision_stack_aligner {
    ...
    /**
     * Overlap pairwise aligner using sliced subdivision algorithm (see
    ...
    class overlap_sliced_subdivision_stack_aligner {
    public:
...
#endif //OFFBYNULL_ALIGNER_ALIGNERS_OVERLAP_SLICED_SUBDIVISION_STACK_ALIGNER_H