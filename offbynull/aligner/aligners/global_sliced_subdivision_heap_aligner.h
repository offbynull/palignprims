#ifndef OFFBYNULL_ALIGNER_ALIGNERS_GLOBAL_SLICED_SUBDIVISION_HEAP_ALIGNER_H
#define OFFBYNULL_ALIGNER_ALIGNERS_GLOBAL_SLICED_SUBDIVISION_HEAP_ALIGNER_H
...
namespace offbynull::aligner::aligners::global_sliced_subdivision_heap_aligner {
    ...
    /**
     * Global pairwise aligner using sliced subdivision algorithm (see
    ...
    class global_sliced_subdivision_heap_aligner {
    public:
...
#endif //OFFBYNULL_ALIGNER_ALIGNERS_GLOBAL_SLICED_SUBDIVISION_HEAP_ALIGNER_H