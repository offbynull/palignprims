#ifndef OFFBYNULL_ALIGNER_SCORERS_PAM70_SCORER_H
#define OFFBYNULL_ALIGNER_SCORERS_PAM70_SCORER_H
...
namespace offbynull::aligner::scorers::pam70_scorer {
...
#endif //OFFBYNULL_ALIGNER_SCORERS_PAM70_SCORER_H
