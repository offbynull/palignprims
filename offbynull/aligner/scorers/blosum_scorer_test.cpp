...
namespace {
    ...
    TEST(OASBlosumScorerTest, SanityTest45) {
        ...
        EXPECT_EQ(-1, (scorer(std::tuple<> {}, { { 0zu, { a_ } } }, { { 0zu, { c_ } } })));
        EXPECT_EQ(12, (scorer(std::tuple<> {}, { { 0zu, { c_ } } }, { { 0zu, { c_ } } })));
        EXPECT_EQ(-1, (scorer(std::tuple<> {}, { { 0zu, { c_ } } }, { { 0zu, { a_ } } })));
    }
    ...
    TEST(OASBlosumScorerTest, SanityTest50) {
        ...
        EXPECT_EQ(5, (scorer(std::tuple<> {}, { { 0zu, { a_ } } }, { { 0zu, { a_ } } })));
        EXPECT_EQ(-1, (scorer(std::tuple<> {}, { { 0zu, { a_ } } }, { { 0zu, { c_ } } })));
        EXPECT_EQ(13, (scorer(std::tuple<> {}, { { 0zu, { c_ } } }, { { 0zu, { c_ } } })));
        EXPECT_EQ(-1, (scorer(std::tuple<> {}, { { 0zu, { c_ } } }, { { 0zu, { a_ } } })));
    }
    ...
    TEST(OASBlosumScorerTest, SanityTest62) {
        ...
        char a_ { 'A' };
        char c_ { 'C' };
        EXPECT_EQ(4, (scorer(std::tuple<> {}, { { 0zu, { a_ } } }, { { 0zu, { a_ } } })));
        EXPECT_EQ(0, (scorer(std::tuple<> {}, { { 0zu, { a_ } } }, { { 0zu, { c_ } } })));
        EXPECT_EQ(9, (scorer(std::tuple<> {}, { { 0zu, { c_ } } }, { { 0zu, { c_ } } })));
        EXPECT_EQ(0, (scorer(std::tuple<> {}, { { 0zu, { c_ } } }, { { 0zu, { a_ } } })));
    }
