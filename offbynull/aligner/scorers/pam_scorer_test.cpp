...
namespace {
    ...
    TEST(OASPamScorerTest, SanityTest30) {
        ...
        EXPECT_EQ(-6, (scorer({ { 0zu, { a_ } } }, { { 0zu, { c_ } } })));
        EXPECT_EQ(10, (scorer({ { 0zu, { c_ } } }, { { 0zu, { c_ } } })));
        EXPECT_EQ(-6, (scorer({ { 0zu, { c_ } } }, { { 0zu, { a_ } } })));
    }
    ...
    TEST(OASPamScorerTest, SanityTest70) {
        ...
        EXPECT_EQ(-4, (scorer({ { 0zu, { c_ } } }, { { 0zu, { a_ } } })));
    }
    ...
    TEST(OASPamScorerTest, SanityTest250) {
        ...
        char a_ { 'A' };
        char c_ { 'C' };
        EXPECT_EQ(2, (scorer({ { 0zu, { a_ } } }, { { 0zu, { a_ } } })));
        EXPECT_EQ(-2, (scorer({ { 0zu, { a_ } } }, { { 0zu, { c_ } } })));
        EXPECT_EQ(12, (scorer({ { 0zu, { c_ } } }, { { 0zu, { c_ } } })));
        EXPECT_EQ(-2, (scorer({ { 0zu, { c_ } } }, { { 0zu, { a_ } } })));
    }
}