#ifndef OFFBYNULL_ALIGNER_SCORERS_BLOSUM90_SCORER_H
#define OFFBYNULL_ALIGNER_SCORERS_BLOSUM90_SCORER_H
...
namespace offbynull::aligner::scorers::blosum90_scorer {
...
* -6 -6 -6 -6 -6 -6 -6 -6 -6 -6 -6 -6 -6 -6 -6 -6 -6 -6 -6 -6 -6 -6 -6 -6  1
    ...
    class blosum90_scorer : public single_character_substitution_matrix_scorer<error_check, WEIGHT, 25zu> {
    public:
        blosum90_scorer()
...
#endif //OFFBYNULL_ALIGNER_SCORERS_BLOSUM90_SCORER_H
