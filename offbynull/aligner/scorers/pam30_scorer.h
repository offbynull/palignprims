#ifndef OFFBYNULL_ALIGNER_SCORERS_PAM30_SCORER_H
#define OFFBYNULL_ALIGNER_SCORERS_PAM30_SCORER_H
...
namespace offbynull::aligner::scorers::pam30_scorer {
...
* -17 -17 -17 -17 -17 -17 -17 -17 -17 -17 -17 -17 -17 -17 -17 -17 -17 -17 -17 -17 -17 -17 -17 -17   1
    ...
    class pam30_scorer : public single_character_substitution_matrix_scorer<debug_mode, WEIGHT, 25zu> {
    public:
        pam30_scorer()
...
#endif //OFFBYNULL_ALIGNER_SCORERS_PAM30_SCORER_H
