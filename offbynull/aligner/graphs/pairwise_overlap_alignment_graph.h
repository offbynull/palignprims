...
namespace offbynull::aligner::graphs::pairwise_overlap_alignment_graph {
    ...
    PACK_STRUCT_START
    /**
     * Edge identifier type for @ref offbynull::aligner::graphs::pairwise_overlap_alignment_graph::pairwise_overlap_alignment_graph.
     *
    ...
    // A scorer that translates calls from the grid_graph backing the pairwise_overlap_alignment_graph, such that the edge identifier type
    // becomes the edge identifier type of pairwise_overlap_alignment_graph.
    /**
     * Pipes offbynull::aligner::scorer::scorer::scorer invocations from
     * @ref offbynull::aligner::graphs::pairwise_overlap_alignment_graph::pairwise_overlap_alignment_graph to its backing
     * @ref offbynull::aligner::graphs::grid_graph::grid_graph instance. Used only for
     * @ref offbynull::aligner::graphs::pairwise_overlap_alignment_graph::edge_type::NORMAL edge types.
     *
    ...
    public:
        ...
        /**
         * Construct an @ref offbynull::aligner::graphs::pairwise_overlap_alignment_graph::grid_scorer_to_overlap_scorer_proxy instance.
         *
     ...
     * pairwise overlap sequence alignment graph.
     *
     * @tparam debug_mode `true` to enable debugging logic, `false` otherwise.
    ...
    private:
        ...
        const grid_graph<
            ...
            DOWN_SEQ,
            RIGHT_SEQ,
            grid_scorer_to_overlap_scorer_proxy<debug_mode, N_INDEX_, DOWN_ELEM, RIGHT_ELEM, WEIGHT, SUBSTITUTION_SCORER>,
            grid_scorer_to_overlap_scorer_proxy<debug_mode, N_INDEX_, DOWN_ELEM, RIGHT_ELEM, WEIGHT, GAP_SCORER>
        > g;
    ...
    public:
        ...
        /**
         * Construct an @ref offbynull::aligner::graphs::pairwise_overlap_alignment_graph::pairwise_overlap_alignment_graph instance.
         *
        ...
        : g {
            down_seq_,
            right_seq_,
            { substitution_scorer_ } /* grid_scorer_to_overlap_scorer_proxy */,
            { gap_scorer_ } /* grid_scorer_to_overlap_scorer_proxy */
        }
        ...
        bidirectional_range_of_non_cvref<E> auto get_edges() const {
            ...
            auto to_sink_range {
                ...
                | std::views::transform([&](const auto & grid_right) {
                    N n1 {
            ...
            auto real_range {
                g.get_edges()
                | std::views::transform([&](const edge<N_INDEX>& e) {
        ...
        full_input_output_range<N, E, ED> auto get_inputs_full(const N& n) const {
            ...
            blankable_bidirectional_view freeride_set_1 {
                ...
                | std::views::transform([this](const N_INDEX& grid_right) {
                    return N {
    ...
    /**
     * Create @ref offbynull::aligner::graphs::pairwise_overlap_alignment_graph::pairwise_overlap_alignment_graph instance, where template
     ...
     * @return New @ref offbynull::aligner::graphs::pairwise_overlap_alignment_graph::pairwise_overlap_alignment_graph instance.
     */
    template<
        bool debug_mode,
        widenable_to_size_t N_INDEX
    >
    auto create_pairwise_overlap_alignment_graph(
        ...
        return pairwise_overlap_alignment_graph<
            debug_mode,
            N_INDEX,
            WEIGHT_1,
            DOWN_SEQ,
...
struct std::formatter<offbynull::aligner::graphs::pairwise_overlap_alignment_graph::overlap_edge<N_INDEX>>
    : std::formatter<std::string_view> {
    auto format(
        const offbynull::aligner::graphs::pairwise_overlap_alignment_graph::overlap_edge<N_INDEX>& e,
...
template<offbynull::concepts::widenable_to_size_t N_INDEX>
std::ostream& operator<<(std::ostream& os, const offbynull::aligner::graphs::pairwise_overlap_alignment_graph::overlap_edge<N_INDEX>& e) {
