#ifndef OFFBYNULL_ALIGNER_GRAPHS_SUFFIX_SLICEABLE_PAIRWISE_ALIGNMENT_GRAPH_H
#define OFFBYNULL_ALIGNER_GRAPHS_SUFFIX_SLICEABLE_PAIRWISE_ALIGNMENT_GRAPH_H
...
namespace offbynull::aligner::graphs::suffix_sliceable_pairwise_alignment_graph {
     ...
     * isolated to some portion starting from some arbitrary node and ending at the leaf node.
     *
    ...
    public:
        ...
        /**
         * Construct an
         * @ref offbynull::aligner::graphs::suffix_sliceable_pairwise_alignment_graph::suffix_sliceable_pairwise_alignment_graph instance.
         *
    ...
    /**
     * Create @ref offbynull::aligner::graphs::suffix_sliceable_pairwise_alignment_graph::suffix_sliceable_pairwise_alignment_graph
     * instance, where template parameters are deduced / inferred from arguments passed in.
     *
     * @tparam debug_mode `true` to enable debugging logic, `false` otherwise.
     * @return New @ref offbynull::aligner::graphs::suffix_sliceable_pairwise_alignment_graph::suffix_sliceable_pairwise_alignment_graph
     *     instance.
     */
    template<
        bool debug_mode
