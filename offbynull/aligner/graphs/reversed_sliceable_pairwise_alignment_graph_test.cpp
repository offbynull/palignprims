...
namespace {
    ...
    TEST(ReversedPairwiseAlignmentGraphTest, SlicedWalk) {
        ...
        auto x = [&](auto&& g) {
            ...
            EXPECT_EQ(g.first_node_in_slice(0u), (N { 0u, 2u }));
            EXPECT_EQ(g.last_node_in_slice(0u), (N { 0u, 0u }));
            EXPECT_EQ(g.first_node_in_slice(1u), (N { 1u, 2u }));
            EXPECT_EQ(g.last_node_in_slice(1u), (N {  1u, 0u }));
