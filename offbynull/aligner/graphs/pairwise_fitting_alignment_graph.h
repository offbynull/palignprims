...
namespace offbynull::aligner::graphs::pairwise_fitting_alignment_graph {
    ...
    PACK_STRUCT_START
    /**
     * Edge identifier type for @ref offbynull::aligner::graphs::pairwise_fitting_alignment_graph::pairwise_fitting_alignment_graph.
     *
    ...
    // A scorer that translates calls from the grid_graph backing the pairwise_fitting_alignment_graph, such that the edge identifier type
    // becomes the edge identifier type of pairwise_fitting_alignment_graph.
    /**
