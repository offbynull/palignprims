...
namespace offbynull::aligner::graphs::pairwise_fitting_alignment_graph {
    ...
    /**
     * @ref offbynull::aligner::graphs::pairwise_fitting_alignment_graph::pairwise_fitting_alignment_graph's edge type.
     */
    ...
    PACK_STRUCT_START
    /**
     * Edge ID type for @ref offbynull::aligner::graphs::pairwise_fitting_alignment_graph::pairwise_fitting_alignment_graph.
     *
    ...
    // A scorer that translates calls from the grid_graph backing the pairwise_fitting_alignment_graph, such that the edge type becomes the
    // edge type of pairwise_fitting_alignment_graph.
    /**
     * Pipes offbynull::aligner::scorer::scorer::scorer invocations from
     * @ref offbynull::aligner::graphs::pairwise_fitting_alignment_graph::pairwise_fitting_alignment_graph to its backing
    ...
    public:
         ...
         */
        grid_scorer_to_fitting_scorer_proxy(
    ...
    public:
        ...
        /**
         * Construct an @ref offbynull::aligner::graphs::pairwise_fitting_alignment_graph::pairwise_fitting_alignment_graph instance.
         *
        ...
        : g {
            down_seq_,
            right_seq_,
            { substitution_scorer_ }, /* grid_scorer_to_fitting_scorer_proxy */
            { gap_scorer_ } /* grid_scorer_to_fitting_scorer_proxy */
        }
        ...
        , node_incoming_edge_capacity { grid_down_cnt - 1zu }
        , node_outgoing_edge_capacity { grid_down_cnt - 1zu } {}
    ...
    /**
     * Create @ref offbynull::aligner::graphs::pairwise_fitting_alignment_graph::pairwise_fitting_alignment_graph instance, where template
     ...
     * @return New @ref offbynull::aligner::graphs::pairwise_fitting_alignment_graph::pairwise_fitting_alignment_graph instance.
     */
    template<
        bool debug_mode,
        widenable_to_size_t INDEX
...
struct std::formatter<offbynull::aligner::graphs::pairwise_fitting_alignment_graph::fitting_edge<INDEX>>
    ...
    auto format(
        ...
        return std::format_to(
            ...
            "{}-{}->{}",
            e.inner_edge.source,
            e.type == offbynull::aligner::graphs::pairwise_fitting_alignment_graph::edge_type::FREE_RIDE ? "fr" : "--",
