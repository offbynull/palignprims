...
namespace {
    ...
    TEST(OAGPairwiseGlobalAlignmentGraphTest, RowWalk) {
        std::string seq1 { "a" };
        std::string seq2 { "ac" };
        pairwise_global_alignment_graph<
            is_debug_mode(),
    ...
    TEST(OAGPairwiseGlobalAlignmentGraphTest, CreateViaFactory) {
        std::string seq1 { "a" };
        std::string seq2 { "ac" };
        pairwise_global_alignment_graph<
            is_debug_mode(),
        ...
        auto g2 { create_pairwise_global_alignment_graph<is_debug_mode(), std::size_t>(seq1, seq2, substitution_scorer, gap_scorer) };
